 ...
 */
 var SidebarMenuEffects = (function() {
  ...
  function initNews() {
    ...
    var container = document.getElementById( 'st-menu-news' ),
      buttons = Array.prototype.slice.call( document.querySelectorAll( 'ul.news-list li' ) ),
    // event type (if mobile use touch events)
      eventtype = mobilecheck() ? 'touchstart' : 'click',
      resetMenu = function() {
        classie.remove( container, 'st-menu-open' );
    ...
    buttons.forEach( function( el, i ) {
      ...
      el.addEventListener( eventtype, function( ev ) {
        ...
        //container.className = 'st-menu-menu'; // clear
        document.getElementById( 'st-container').className = 'st-container';
        $(".st-menu-news").html($.parseJSON($(this).data( 'text' )));
        classie.add( container, effect );
        classie.add( document.getElementById( 'st-container' ), effect );
        setTimeout( function() {
          classie.add( container, 'st-menu-open' );
