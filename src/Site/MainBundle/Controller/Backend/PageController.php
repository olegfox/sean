...
class PageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('SiteMainBundle:Backend/Page:index.html.twig', array(
            'entities' => $pagination,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('backend_page_show', array('id' => $entity->getId())));
        }
    ...
    */
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('backend_page_show', array('id' => $id)));
        }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('backend_page_delete', array('id' => $id)))
            ->setMethod('DELETE')
